...
public partial class SecondaryScreen : UserControl
{
    ...
    private void OnHelpClicked(object sender, RoutedEventArgs e)
    {
        ...
        new SecondaryHelpWindow(rosetta, "view.secondaryresults.help") { Owner = Window.GetWindow(this) }.ShowDialog();
    }

    private void OnExportClicked(object sender, RoutedEventArgs e)
    {
        if (DataContext is not SecondaryViewModel vm) return;
