...
public partial class SecondaryViewModel : ObservableObject
{
    ...
    private ObservableCollection<TransitPositionRow> _positionRows = [];
    ...
    // Labels — input screen
    public string LabelTitle        => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.title");
    public string LabelNoSession    => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.nosession");
    public string LabelChartSection => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.chartsection");
    public string LabelEventsHeader => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.eventsheader");
    public string LabelNoEvents     => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.noevents");
    public string LabelCalculate    => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.calculate");
    public string LabelColTitle     => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.col.title");
    public string LabelColDateTime  => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.col.datetime");
    public string LabelColLocation  => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.col.location");
    public string LabelSelect       => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.select");
    public string LabelErrorNoNatal => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.error.nonatal");
    public string LabelHelp         => _rosetta.GetText(RbFile.Secondary, "view.secondaryscreen.help");
    public string LabelResultsHelp  => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.help");
    ...
    public string LabelResultsTitle   => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.title");
    public string LabelNoResults      => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.noresults");
    public string LabelTabPositions   => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.tab.positions");
    public string LabelTabMatches     => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.tab.matches");
    public string LabelTabMidpoints   => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.tab.midpoints");
    public string LabelTabDualWheel   => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.tab.dualwheel");
    public string LabelMidpointsRadixHeader      => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.midpoints.radixheader");
    public string LabelMidpointsProgressiveHeader => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.midpoints.secondaryheader");
    public string LabelMidpointsNoMatches        => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.midpoints.nomatches");
    ...
    public string LabelColFactor      => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.col.factor");
    public string LabelColLongitude   => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.col.longitude");
    public string LabelColDeclination => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.col.declination");
    public string LabelMatchColOrb    => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.matches.col.orb");
    public string LabelMatchColExactness => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.matches.col.exactness");
    public string LabelNoMatches      => _rosetta.GetText(RbFile.Secondary, "view.secondaryresults.matches.nomatches");
    ...
    private void Calculate()
    {
        ...
        try
        {
            ...
            var request = new ProgressiveCalcRequest(
                ...
                ProgressiveMethods.SecDir,
                NatalJulianDay: _natalJulianDay);

            _results = _orchestrator.ProgressivePositions(request);
            BuildPositionRows();
            BuildMatchRows();
            BuildMidpointRows();
            BuildWheelData();
    ...
    private void BuildPositionRows()
    {
        var rows = _results
            ...
            .Select((kvp, i) => new TransitPositionRow(kvp.Key, kvp.Value, i))
            .ToList();
        PositionRows = new ObservableCollection<TransitPositionRow>(rows);
    }
    ...
    private void BuildMatchRows()
    {
        ...
        var config      = _configContext.ActiveConfig;
        var baseOrb     = config.ProgressionsConfig.SecondaryDirections.Orb;
