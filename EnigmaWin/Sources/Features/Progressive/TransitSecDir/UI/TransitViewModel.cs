...
public partial class TransitViewModel : ObservableObject
{
    ...
    // Labels — input screen
    public string LabelTitle        => _rosetta.GetText(RbFile.Transit, "view.transitscreen.title");
    public string LabelNoSession    => _rosetta.GetText(RbFile.Transit, "view.transitscreen.nosession");
    public string LabelChartSection => _rosetta.GetText(RbFile.Transit, "view.transitscreen.chartsection");
    public string LabelEventsHeader => _rosetta.GetText(RbFile.Transit, "view.transitscreen.eventsheader");
    public string LabelNoEvents     => _rosetta.GetText(RbFile.Transit, "view.transitscreen.noevents");
    public string LabelCalculate    => _rosetta.GetText(RbFile.Transit, "view.transitscreen.calculate");
    public string LabelColTitle     => _rosetta.GetText(RbFile.Transit, "view.transitscreen.col.title");
    public string LabelColDateTime  => _rosetta.GetText(RbFile.Transit, "view.transitscreen.col.datetime");
    public string LabelColLocation  => _rosetta.GetText(RbFile.Transit, "view.transitscreen.col.location");
    public string LabelSelect       => _rosetta.GetText(RbFile.Transit, "view.transitscreen.select");
    public string LabelHelp         => _rosetta.GetText(RbFile.Transit, "view.transitscreen.help");
    public string LabelResultsHelp  => _rosetta.GetText(RbFile.Transit, "view.transitresults.help");
    ...
    public string LabelResultsTitle   => _rosetta.GetText(RbFile.Transit, "view.transitresults.title");
    public string LabelNoResults      => _rosetta.GetText(RbFile.Transit, "view.transitresults.noresults");
    public string LabelTabPositions   => _rosetta.GetText(RbFile.Transit, "view.transitresults.tab.positions");
    public string LabelTabMatches     => _rosetta.GetText(RbFile.Transit, "view.transitresults.tab.matches");
    public string LabelTabMidpoints   => _rosetta.GetText(RbFile.Transit, "view.transitresults.tab.midpoints");
    public string LabelTabDualWheel   => _rosetta.GetText(RbFile.Transit, "view.transitresults.tab.dualwheel");
    public string LabelMidpointsRadixHeader      => _rosetta.GetText(RbFile.Transit, "view.transitresults.midpoints.radixheader");
    public string LabelMidpointsProgressiveHeader => _rosetta.GetText(RbFile.Transit, "view.transitresults.midpoints.transitheader");
    public string LabelMidpointsNoMatches        => _rosetta.GetText(RbFile.Transit, "view.transitresults.midpoints.nomatches");
    ...
    public string LabelColFactor      => _rosetta.GetText(RbFile.Transit, "view.transitresults.col.factor");
    public string LabelColLongitude   => _rosetta.GetText(RbFile.Transit, "view.transitresults.col.longitude");
    public string LabelColDeclination => _rosetta.GetText(RbFile.Transit, "view.transitresults.col.declination");
    public string LabelMatchColOrb    => _rosetta.GetText(RbFile.Transit, "view.transitresults.matches.col.orb");
    public string LabelMatchColExactness => _rosetta.GetText(RbFile.Transit, "view.transitresults.matches.col.exactness");
    public string LabelNoMatches      => _rosetta.GetText(RbFile.Transit, "view.transitresults.matches.nomatches");
    ...
    public async Task LoadEventsAsync()
    {
        ...
        try
        {
            ...
            if (horoscope is null) { _rawEvents = []; RebuildRows(); return; }
    ...
    public void SetEvents(IEnumerable<ChartEvent> events, FullChart? radixChart)
    {
    ...
    private void Calculate()
    {
        ...
        try
        {
            ...
            var request = new ProgressiveCalcRequest(SelectedEvent.JulianDate, ProgressiveMethods.Transit);
