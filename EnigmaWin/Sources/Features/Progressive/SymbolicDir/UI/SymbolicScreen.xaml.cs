...
public partial class SymbolicScreen : UserControl
{
    public SymbolicScreen()
    {
        InitializeComponent();
    }
    ...
    private void OnHelpClicked(object sender, RoutedEventArgs e)
    {
        ...
        new SymbolicHelpWindow(rosetta, "view.symbolicresults.help") { Owner = Window.GetWindow(this) }.ShowDialog();
    }

    private void OnExportClicked(object sender, RoutedEventArgs e)
    {
        if (DataContext is not SymbolicViewModel vm) return;
