...
public partial class EventEditScreen : UserControl
{
    private EventEditViewModel Vm => (EventEditViewModel)DataContext;

    public EventEditScreen() => InitializeComponent();
