...
/// <summary>
/// FrameworkElement for the 90° dial wheel.
/// Planets are placed at (ecliptic longitude mod 90) × 4 visual degrees.
/// Supports hover and click to show midpoint overlay lines.
/// </summary>
public class Dial90WheelCanvas : FrameworkElement
{
    public static readonly DependencyProperty PlotDataProperty =
        DependencyProperty.Register(nameof(PlotData), typeof(WheelPlotData), typeof(Dial90WheelCanvas),
            new PropertyMetadata(WheelPlotData.Empty, OnVisualPropertyChanged));

    public static readonly DependencyProperty ThemeProperty =
        DependencyProperty.Register(nameof(Theme), typeof(WheelTheme), typeof(Dial90WheelCanvas),
    ...
    private static void OnVisualPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        => ((Dial90WheelCanvas)d).InvalidateVisual();
