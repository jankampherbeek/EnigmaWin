...
public static class ChartWheelKeys
{
    ...
    public const string ShowAspectsButton = "view.chartwheel.button.showaspects";
    public const string NoTimeButton      = "view.chartwheel.button.notime";
    public const string WithTimeButton    = "view.chartwheel.button.withtime";
    ...
    public const string ExportCancel = "view.chartwheel.export.cancel";
}
