// ConfigFactorSectionScreen.xaml.cs
...
public partial class ConfigFactorSectionScreen : UserControl
{
    private ConfigFactorSectionViewModel? _vm;

    public ConfigFactorSectionScreen()
    {
        InitializeComponent();
    ...
    {
        _vm = DataContext as ConfigFactorSectionViewModel;
    }
    ...
    private void OnHelpClicked(object sender, RoutedEventArgs e)
    {
        ...
        {
            Title = _vm.LabelHelpTitle, Width = 500, Height = 280,
