...
public sealed partial class ConfigOrbSectionViewModel : ObservableObject
{
    ...
    private int _origMidpointDeg, _origMidpointMin;
    ...
    [ObservableProperty][NotifyPropertyChangedFor(nameof(IsDirty))]
    private decimal? _midpointDeg;
    [ObservableProperty][NotifyPropertyChangedFor(nameof(IsDirty))]
    private decimal? _midpointMin;
    ...
    public bool IsDirty =>
        ...
        (int)(MidpointDeg   ?? 0) != _origMidpointDeg         ||
        (int)(MidpointMin   ?? 0) != _origMidpointMin         ||
    ...
    public string LabelMidpoint       => _rosetta.GetText(RbFile.ConfigEdit, "view.configedit.orb.midpoint");
    ...
    internal async Task SaveAsync()
    {
        ...
        config.OrbConfig = new OrbConfig(
            ...
            FromSexagesimal(MidpointDeg,   MidpointMin),
    ...
    internal void Revert()
    {
        ...
        MidpointDeg   = _origMidpointDeg; MidpointMin = _origMidpointMin;
    ...
    private void SaveOriginals()
    {
        ...
        _origMidpointDeg= (int)(MidpointDeg   ?? 0); _origMidpointMin= (int)(MidpointMin   ?? 0);
