// HarmonicOrbsInputScreen.xaml.cs
...
public partial class HarmonicOrbsInputScreen : UserControl
{
    public HarmonicOrbsInputScreen()
    {
        InitializeComponent();
    }
    ...
    private void OnFactsheetClicked(object sender, RoutedEventArgs e)
    {
        ...
        new HarmonicOrbsFactsheetWindow(rosetta) { Owner = Window.GetWindow(this) }.ShowDialog();
    }
