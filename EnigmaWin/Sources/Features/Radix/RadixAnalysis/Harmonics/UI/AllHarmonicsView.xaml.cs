...
public partial class AllHarmonicsView : UserControl
{
    public AllHarmonicsView()
    {
        InitializeComponent();
    }
    ...
    private void OnHelpClicked(object sender, RoutedEventArgs e)
    {
        var app = (App)Application.Current;
        var rosetta = app.Services.GetRequiredService<IRosetta>();
        new AllHarmonicsHelpWindow(rosetta) { Owner = Window.GetWindow(this) }.ShowDialog();
    }
}
