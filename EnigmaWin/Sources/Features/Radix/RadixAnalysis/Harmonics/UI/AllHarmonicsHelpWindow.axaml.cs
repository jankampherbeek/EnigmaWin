// AllHarmonicsHelpWindow.axaml.cs
...
public partial class AllHarmonicsHelpWindow : Window
{
    public IReadOnlyList<string> HelpParagraphs { get; }
    public string LabelClose { get; }

    public AllHarmonicsHelpWindow(IRosetta rosetta)
    {
        var raw = rosetta.GetText(RbFile.RadixHarmonics, "harmonics.allharmonics.help");
