// AllMidpointsHelpWindow.axaml.cs
...
public partial class AllMidpointsHelpWindow : Window
{
    public IReadOnlyList<string> HelpParagraphs { get; }
    public string LabelClose { get; }

    public AllMidpointsHelpWindow(IRosetta rosetta)
    {
        var raw = rosetta.GetText(RbFile.RadixMidpoints, "midpoints.allmidpoints.help");
