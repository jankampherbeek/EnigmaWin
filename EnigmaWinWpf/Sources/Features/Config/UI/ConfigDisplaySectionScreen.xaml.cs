// ConfigDisplaySectionScreen.xaml.cs
...
public partial class ConfigDisplaySectionScreen : UserControl
{
    ...
    private void OnHelpClicked(object sender, RoutedEventArgs e)
    {
        ...
        ShowHelp(_vm.LabelHelpTitle, 480, 300,
            _vm.LabelHelpLine1, _vm.LabelHelpLine2, _vm.LabelHelpLine3, _vm.LabelHelpLine4);
    }
    ...
    private void ShowHelp(string title, double width, double height, params string[] lines)
    {
        ...
        var closeBtn = new Button { Content = _vm?.LabelHelpClose ?? "Close", HorizontalAlignment = HorizontalAlignment.Right };
