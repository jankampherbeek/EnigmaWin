// ConfigSecondaryDirectionsSectionScreen.xaml.cs
...
public partial class ConfigSecondaryDirectionsSectionScreen : UserControl
{
    private ConfigSecondaryDirectionsSectionViewModel? _vm;

    public ConfigSecondaryDirectionsSectionScreen()
    {
        InitializeComponent();
    ...
    {
        _vm = DataContext as ConfigSecondaryDirectionsSectionViewModel;
    }
    ...
    private void OnHelpClicked(object sender, RoutedEventArgs e)
    {
        ...
        foreach (var line in new[] { _vm.LabelHelpLine1, _vm.LabelHelpLine2 })
