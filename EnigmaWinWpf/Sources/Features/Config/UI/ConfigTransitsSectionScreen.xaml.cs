// ConfigTransitsSectionScreen.xaml.cs
...
public partial class ConfigTransitsSectionScreen : UserControl
{
    private ConfigTransitsSectionViewModel? _vm;

    public ConfigTransitsSectionScreen()
    {
        InitializeComponent();
    ...
    {
        _vm = DataContext as ConfigTransitsSectionViewModel;
    }
